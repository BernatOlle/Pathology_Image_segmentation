...
data_val_for_train = dict(
    data_prefix=dict(
        img_path=
        '/mnt/work/datasets/BKidney/KPIS/KPIs24 Validation Data/Task1_patch_level/validation'
    ),
    data_root='',
    pipeline=[
...
test_data_as_val = dict(
    data_prefix=dict(
        img_path=
        '/mnt/work/datasets/BKidney/KPIS/KPIs24 Testing Data/Task1_patch_level/test'
    ),
    data_root='',
    pipeline=[
        dict(type='LoadImageFromFile'),
    ...
    dataset=dict(
        datasets=[
            dict(
                data_prefix=dict(
                    img_path=
                    '/mnt/work/datasets/BKidney/KPIS/KPIs24 Training Data/Task1_patch_level/train'
                ),
                data_root='',
                pipeline=[
                    dict(type='LoadImageFromFile'),
